export default {
    ...
    'creditCard.expiryDateField.invalid': '유효하지 않은 만료일',
    ...
    'creditCard.oneClickVerification.invalidInput.title': '유효하지 않은 CVC/CVV 형식',
    ...
    'voucher.collectionInstitutionNumber': '콜렉션 기관 번호',
