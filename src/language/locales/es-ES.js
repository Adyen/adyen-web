export default {
    ...
    'creditCard.oneClickVerification.invalidInput.title': 'El formato CVC/CVV no es válido',
    ...
    'giropay.minimumLength': 'Mín. 4 caracteres',
    'giropay.noResults': 'No hay resultados de búsqueda',
    'giropay.details.bic': 'BIC (código de identificación bancaria)',
    'error.title': 'Error',
    ...
    'voucher.collectionInstitutionNumber': 'Número de institución de cobranza',
    ...
    applyGiftcard: 'Aplicar tarjeta regalo',
    ...
    'swish.pendingMessage':
        'Tras escanearlo, su estado puede seguir en pendiente hasta 10 minutos. Podrían realizarse varios cargos si se intenta pagar de nuevo durante este periodo.'
};
