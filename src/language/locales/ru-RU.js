export default {
    ...
    'creditCard.expiryDateField.invalid': 'Указан неверный срок действия',
    ...
    'creditCard.oneClickVerification.invalidInput.title': 'Неверный формат CVC / CVV',
    ...
    'creditCard.taxNumber.invalid': 'Неверная дата рождения владельца карты или регистрационного номера предприятия',
    ...
    'blik.help': 'Получите код из банковского приложения.',
