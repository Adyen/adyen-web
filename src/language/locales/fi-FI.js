export default {
    'paymentMethods.moreMethodsButton': 'Lisää maksutapoja',
    payButton: 'Maksa',
    ...
    'payment.processing': 'Maksuasi käsitellään',
    ...
    'creditCard.numberField.invalid': 'Väärä kortin numero',
    'creditCard.expiryDateField.title': 'Voimassaolopäivämäärä',
    'creditCard.expiryDateField.placeholder': 'KK / VV',
    'creditCard.expiryDateField.invalid': 'Virheellinen vanhenemispäivämäärä',
    ...
    'creditCard.oneClickVerification.invalidInput.title': 'Virheellinen CVC / CVV-muoto',
    ...
    'giropay.minimumLength': 'Väh. 4 merkkiä',
    ...
    applyGiftcard: 'Käytä lahjakorttia',
