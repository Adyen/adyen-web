export default {
    'paymentMethods.moreMethodsButton': 'Mais métodos de pagamento',
    payButton: 'Pagar',
    'payButton.redirecting': 'Redirecionando...',
    storeDetails: 'Salvar para meu próximo pagamento',
    'payment.redirecting': 'Você será redirecionado…',
    ...
    'creditCard.numberField.invalid': 'Número de cartão inválido',
    'creditCard.expiryDateField.title': 'Data de validade',
    'creditCard.expiryDateField.placeholder': 'MM/AA',
    'creditCard.expiryDateField.invalid': 'Data de vencimento inválida',
    ...
    'creditCard.oneClickVerification.invalidInput.title': 'Formato de CVC/CVV inválido',
    ...
    'giropay.minimumLength': 'Mínimo de 4 caracteres',
    'giropay.noResults': 'Não há resultados de pesquisa',
    'giropay.details.bic': 'BIC (Código de identificação do banco)',
    'error.title': 'Erro',
