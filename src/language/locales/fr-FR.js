export default {
    'paymentMethods.moreMethodsButton': 'Plus de méthodes de paiement',
    payButton: 'Payer',
    'payButton.redirecting': 'Redirection...',
    storeDetails: 'Sauvegarder pour mon prochain paiement',
    'payment.redirecting': 'Vous allez être redirigé…',
    ...
    'creditCard.numberField.invalid': 'Numéro de carte non valide',
    'creditCard.expiryDateField.title': "Date d'expiration",
    'creditCard.expiryDateField.placeholder': 'MM/AA',
    'creditCard.expiryDateField.invalid': "Date d'expiration incorrecte",
    ...
    'creditCard.oneClickVerification.invalidInput.title': 'Format CVC/CVV incorrect',
    ...
    'giropay.minimumLength': '4 caractères minimum',
    'giropay.noResults': 'Aucun résultat',
    ...
    applyGiftcard: 'Utiliser une carte-cadeau',
    ...
    'creditCard.taxNumber.label':
        "Date de naissance du porteur de carte (au format AAMMJJ) ou numéro d'identification de l'entreprise (à 10 chiffres)",
    ...
    'swish.pendingMessage':
        "Après avoir scanné le code QR, la mise à jour du statut de paiement peut prendre jusqu'à 10 minutes. Si vous effectuez une nouvelle tentative de paiement dans ce délai, cela pourrait occasionner plusieurs débits."
};
