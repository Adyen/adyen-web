...
fixture`Test how Card Component handles binLookup returning a panLength property for a card with a social security number`
    .beforeEach(async t => {
    ...
    .clientScripts('./panLength.ssn.clientScripts.js');
