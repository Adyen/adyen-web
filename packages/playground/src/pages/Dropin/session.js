import { AdyenCheckout, Dropin, Card, WeChat, Giftcard, PayPal, Ach, GooglePay, Riverty, Bancontact, Ideal } from '@adyen/adyen-web';
...
export async function initSession() {
    ...
    const dropin = new Dropin(checkout, {
        ...
        paymentMethodComponents: [Card, WeChat, Giftcard, PayPal, Ach, GooglePay, Riverty, Bancontact, Ideal],
