...
class DonationCampaignProvider {
    ...
    constructor(props?: DonationCampaignProviderProps) {
        ...
        console.log('### DonationCampaignProvider2::constructor:: this.rootNode', this.rootNode);
    ...
    private callSessionsDonationCampaigns() {
        ...
        this.makeSessionsDonationCampaignsCall()
            ...
            .catch((error: unknown) => {
                console.debug('DonationCampaignProvider2::makeSessionDonationCampaignsCall:: error', error);
            });
    }
