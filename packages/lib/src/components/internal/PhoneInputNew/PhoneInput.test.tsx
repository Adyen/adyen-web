...
import { resolveCDNEnvironment } from '../../../core/Environment';
...
describe('PhoneInput', () => {
    ...
    const renderPhoneInput = (props: PhoneInputProps = defaultProps) => {
        return render(
            // @ts-ignore ignore
            <CoreProvider i18n={global.i18n} loadingContext="test" resources={new Resources(resolveCDNEnvironment('test'))}>
                <PhoneInput {...props} />
            </CoreProvider>
        );
    };
