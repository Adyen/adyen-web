 ...
 */
export function processAriaConfig(txVariant: string, fieldType: string, i18n: Language): AriaConfig {
    ...
    const ariaFieldConfigWithErrorsAndContext = addContextTranslationsToObject(ariaFieldConfigWithTranslatedErrors, i18n, txVariant, fieldType);
