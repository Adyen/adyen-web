...
const TRANSLATED_NUMBER_IFRAME_LABEL = en['creditCard.encryptedCardNumber.aria.label'];

const TRANSLATED_DATE_IFRAME_TITLE = en['creditCard.encryptedExpiryDate.aria.iframeTitle'];
const TRANSLATED_DATE_IFRAME_LABEL = en['creditCard.encryptedExpiryDate.aria.label'];

const TRANSLATED_CVC_IFRAME_TITLE = en['creditCard.encryptedSecurityCode.aria.iframeTitle'];
const TRANSLATED_CVC_IFRAME_LABEL = en['creditCard.encryptedSecurityCode.aria.label'];
...
describe('SecuredField handling placeholders overridden with translations config object - overridden placeholders should be used', () => {
    ...
    describe('Setting empty placeholder', () => {
        beforeEach(() => {
            i18n = new Language('en-US', {
                'en-US': {
