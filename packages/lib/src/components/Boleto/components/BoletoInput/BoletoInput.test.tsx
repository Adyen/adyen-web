...
import BoletoInput, { BoletoInputProps } from './BoletoInput';
...
describe('BoletoInput', () => {
    ...
    test('should render BrazilPersonalDetail by default', async () => {
        customRender(<BoletoInput {...boletoInputPropsMock} />);
    ...
    test('should show form instruction if either the personal detail or the address form is shown', async () => {
        customRender(<BoletoInput {...boletoInputPropsMock} personalDetailsRequired={false} />);
        expect(await screen.findByText(/All fields are required unless marked otherwise./i)).toBeTruthy();
    });

    test('should not show form instruction if neither the personal detail nor the address form is shown', () => {
        customRender(<BoletoInput {...boletoInputPropsMock} personalDetailsRequired={false} billingAddressRequired={false} />);
