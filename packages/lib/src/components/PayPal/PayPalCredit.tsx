...
class PayPalCreditElement extends UIElement<PayPalConfiguration> {
    public static type = TxVariants.paypal_credit;
    ...
    public override async isAvailable(): Promise<void> {
        ...
        if (!this.paypalService.paymentMethods.isEligible('credit')) {
            return Promise.reject(new Error('PayPal Credit is not eligible'));
        }
