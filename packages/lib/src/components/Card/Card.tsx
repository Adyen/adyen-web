...
export class CardElement extends UIElement<CardElementProps> {
    ...
    formatData(): CardElementData {
         ...
         * this.state.dualBrandSelectedValue will be set when /binLookup detects a single brand &/or when /binLookup detects a dual-branded card and
         *  the shopper makes a brand selection
         */
        const cardBrand = this.state.dualBrandSelectedValue || this.props.brand;
