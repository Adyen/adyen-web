...
test('should return expected data to perform the payment', () => {
    const payByBankEle = new PayByBank({ core: global.core });
    expect(payByBankEle.formatData()).toEqual({ paymentMethod: { type: 'paybybank' } });
});

test('should show the pay button by default', async () => {
    const payByBankEle = new PayByBank({ core: global.core, name: 'Pay By Bank', i18n: global.i18n });
...
test('should hide pay button if property is set to false', () => {
    const payByBankEle = new PayByBank({ core: global.core, showPayButton: false, i18n: global.i18n });
    render(payByBankEle.render());
...
test('should trigger submit when Pay button is pressed', async () => {
    ...
    const payByBankEle = new PayByBank({ core: global.core, showPayButton: true, name: 'Pay By Bank', i18n: global.i18n });
