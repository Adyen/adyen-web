...
export const ANALYTICS_ERROR_CODE_TOKEN_IS_MISSING_OTHER_PROPS = 'web_703'; // Decoded token is missing one or more of the following properties (threeDSMethodNotificationURL | postMessageDomain | threeDSServerTransID)
...
export const ANALYTICS_ERROR_CODE_3DS2_FINGERPRINT_TIMEOUT = 'web_705'; // 3DS2 fingerprinting process has timed out
