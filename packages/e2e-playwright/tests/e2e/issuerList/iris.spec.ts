...
test.describe('IRIS Payment Method', () => {
    test(
        ...
        async ({ iris }) => {
            ...
            await expect(iris.rootElement).toHaveScreenshot('iris-bank-list-mode.png');
            ...
            await expect(iris.rootElement).toHaveScreenshot('iris-bank-list-selected.png');
    ...
    test('QR Code Flow - should display QR code image and data after generating', { tag: ['@screenshot'] }, async ({ page, iris }) => {
        ...
        await expect(iris.generateQrCodeContainer).toHaveScreenshot('iris-qr-code-mode.png');
        ...
        await expect(iris.qrCodeContainer).toHaveScreenshot('iris-qr-code-generated.png', {
