export const URL_MAP = {
    ...
    giftcard_with_card: '/iframe.html?globals=&id=components-partial-payments-givex-giftcard--with-card&viewMode=story',
    giftcard_with_giftcard: '/iframe.html?globals=&id=components-partial-payments-givex-giftcard--with-gift-card&viewMode=story',
