...
| `e2e-tests.yml` | `e2e-tests` | 120 min | **Regular PRs/merges**: 1 API version (v71, latest) x 3 browsers (chromium, firefox, webkit) x 2 test types (e2e, ui)<br>**Release PR** (`changeset-release/*`): all API versions — 3 API versions (v69, v70, v71) x 3 browsers x 2 test types (e2e, ui) | Playwright E2E tests. Uploads report artifacts. Takes an `all-api-versions` input (see below). |
